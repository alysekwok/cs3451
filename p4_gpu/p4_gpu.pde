...
void draw() {
  ...
  for (int i = 0; i < 50; i++) {
    for (int j = 0; j < 50; j++) {
      beginShape();
      texture(sheep_texture); 
      vertex(i * 5.0, (j * 5.0) + 50, 0, i/50.0, j/50.0);
      vertex((i+1) * 5.0, (j * 5.0) + 50, 0, (i+1)/50.0, j/50.0);
      vertex((i+1) * 5.0, ((j+1) * 5.0) + 50, 0, (i+1)/50.0, (j+1)/50.0);
      vertex(i * 5.0, ((j+1) * 5.0) + 50, 0, i/50.0, (j+1)/50.0);
      endShape();
    } 
  }
  popMatrix();
